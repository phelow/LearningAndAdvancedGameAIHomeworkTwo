...
public class CustomMLP implements FA<double[], double[]>, Evolvable
{
    ...
    public CustomMLP(int numberOfInputs, int numberOfHidden, int numberOfOutputs)
    {
        ...
        thirdConnectionLayer = new double[numberOfHidden][numberOfOutputs];
        fourthConnectionLayer = new double[numberOfHidden][numberOfOutputs];
    ...
    public CustomMLP(double[][] firstConnectionLayer, double[][] secondConnectionLayer, int numberOfHidden,
               int numberOfOutputs)
    {
    ...
    {
    	CustomMLP copy = new CustomMLP(copy(firstConnectionLayer), copy(secondConnectionLayer),
